// REFORGED v10.3 — Consistent Mode Toggle Message
...
const AppContent: React.FC = () => {
  ...
  // ✅ UPDATED: The system message now uses the correct glyph format.
    ...
    setThreadList((prev) =>
      prev.map((t) => t.id === activeThreadId
        ? {
            ...
            messages: [
              ...t.messages,
              { sender: "System", text: `༄∞ᛝ𓆩⫷ ${newMode} ∆ møde ⫸𓆪ᛝ∞༄`, systemType: "announcement" },
            ],
          }
        : t
      )
